...
//NOTE: when the program is running, you will need to use the Browser to trigger the Prometheus
//endpoint  http://**.**.**.**:8080/metrics, and from the console, you will see the callback functions
//get invoked, as follows:
//
// I0510 09:40:01.690119  1960 test_detailed_metrics_with_callbacks.cpp:25] making call from test class 1
// I0510 09:40:01.690150  1960 test_detailed_metrics_with_callbacks.cpp:32] making call from test class 2
//
// invoke the program  ./test_metrics_with_callbacks 10.254.40.173
...
int main (int argc, char ** argv) {
  ...
  monitor::MetricsMonitor::Instance().RegisterCollectionCallback(
                 SimpleCallBackTestClass::callback);
