# SymbiosisLib (sisl)
[![Conan Build](https://github.com/eBay/sisl/actions/workflows/conan_build.yml/badge.svg?branch=master)](https://github.com/eBay/sisl/actions/workflows/conan_build.yml)
