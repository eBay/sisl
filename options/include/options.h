...
#define SDS_OPTION_ENABLE(r, _, group)                                                                                 \
    ...
    static std::unique_ptr< BOOST_PP_CAT(sds_options::options_module_, group),                                         \
                            decltype(&BOOST_PP_CAT(sds_options::unload_options_, group)) >                             \
        BOOST_PP_CAT(options_group_, group)(nullptr, &BOOST_PP_CAT(sds_options::unload_options_, group));
...
#define SDS_OPTION_LOAD(r, _, group)                                                                                   \
    BOOST_PP_CAT(options_group_, group) = decltype(BOOST_PP_CAT(options_group_, group))(                               \
        BOOST_PP_CAT(sds_options::load_options_, group)(), &BOOST_PP_CAT(sds_options::unload_options_, group));
