...
#
#     flatbuffer_gen_cpp (<flatbuffer_bin_path> <file_path_to_generate> <target to build> <*.proto files> )
#
#   ``ARGN``
#     ``.fbs`` files
#
macro(flatbuffer_gen_cpp flatbuffer_bin_path gen_out_path _target)
...
#    endif()
    ...
    foreach(FIL ${ARGN})
        ...
        message(STATUS "flatbuffer_gen_cpp: processing ${ABS_FIL}")
        ...
        target_sources(${_target} PRIVATE ${_GEN_HEADERS})
        set_source_files_properties(${_GEN_HEADERS} PROPERTIES GENERATED TRUE)
